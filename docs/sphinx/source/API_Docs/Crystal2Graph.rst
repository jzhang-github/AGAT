...
.. py:class:: TrainValTestSplit(object)
   ...
   .. py:method:: __call__(self):
      ...
      Write three files: ``'train.txt'``, ``'validation.txt'``, ``'test.txt'`` containing the index of different datasets. The directory including these files is the directory to the csv file.
